        ...
        <div class="p-6 sm:p-10 lg:p-12">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 py-6 border-y border-slate-100 dark:border-slate-700/80 mb-12">
                ...
                <div class="flex items-center gap-3 shrink-0">
                    ...
                    {{-- Pinterest --}}
                    <a href="https://www.pinterest.com/pin/create/button/?url={{ rawurlencode(url()->current()) }}&description={{ rawurlencode($post->title) }}@if($post->featured_image)&media={{ rawurlencode(asset('storage/' . $post->featured_image)) }}@endif" target="_blank" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center rounded-full bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 text-slate-500 hover:bg-[#E60023] hover:text-white hover:border-[#E60023] shadow-sm hover:shadow-[0_4px_15px_rgba(230,0,35,0.3)] transition-all duration-300 hover:-translate-y-1" title="Chia sẻ qua Pinterest">
