        ...
        <div class="bg-white dark:bg-slate-800/80 backdrop-blur-xl p-6 rounded-3xl shadow-sm border border-brand/10 dark:border-slate-700/50">
            ...
            <div class="mt-6 pt-6 border-t border-slate-100 dark:border-slate-700/50">
                ...
                <div class="flex items-center gap-3">
                    ...
                    {{-- Nút chia sẻ Threads --}}
                    <a href="https://www.threads.net/intent/post?text={{ urlencode($game->title . ' ' . url()->current()) }}" target="_blank" class="p-2.5 rounded-full bg-slate-100 text-slate-800 hover:bg-black hover:text-white dark:bg-slate-700 dark:text-slate-300 dark:hover:bg-black transition-colors" data-tippy-content="Chia sẻ Threads">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M14.647 4.081A.724.724 0 0 0 14.22 4c-4.664 0-8.625 2.148-11.455 6.066C.252 13.568 0 17.616 0 21.054c0 .878.225 1.705.65 2.428a3.528 3.528 0 0 0 1.83 1.488 4.675 4.675 0 0 0 2.17.15c4.614-.492 8.35-3.328 10.375-7.87 2.053-4.6 2.083-9.58 2.083-9.58 0-.416-.36-.75-.806-.75h-1.655zm-1.077 15.548c-1.393 2.97-4.043 5.097-7.464 5.46a3.27 3.27 0 0 1-1.517-.1 2.084 2.084 0 0 1-1.079-.877c-.317-.54-.485-1.16-.485-1.82 0-3.21.238-6.93 2.502-10.392C7.872 8.643 11.233 6.75 15.012 6.75h.003c0 .022-.016 3.655-1.444 6.853-1.002 2.247-2.7 3.606-4.57 3.606-1.583 0-2.454-1.2-2.454-2.88 0-1.896 1.34-3.895 3.397-3.895 1.056 0 1.944.577 2.43 1.57.172.35.263.74.263 1.15 0 2.227-1.487 3.86-3.415 3.86-1.436 0-2.618-1.226-2.618-2.924 0-2.27 1.258-4.14 3.023-4.14 1.325 0 2.302.94 2.302 2.463 0 .195-.018.39-.052.576-.328 1.85-1.745 3.013-3.284 3.013-2.613 0-4.63-2.023-4.63-5.285 0-3.92 2.364-7.258 6.452-9.145l.63-.293c.176-.08.384.05.384.246 0 0 .1 5.045-2.036 9.83-1.636 3.66-4.707 5.92-8.358 6.31-1.397.148-2.617-.234-3.37-.992-.72-.72-1.028-1.76-1.028-2.84 0-3.344.254-7.218 2.658-10.536C7.113 4.398 10.635 2.5 14.887 2.5c.29 0 .573.014.85.042.368.037.608.375.608.746v2.115c0 .36-.26.664-.618.706a14.735 14.735 0 0 0-1.08.072z"></path></svg>
                    </a>
