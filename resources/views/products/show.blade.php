    ...
    <div class="flex flex-col lg:flex-row gap-12 mb-12">
        ...
        <div class="w-full lg:w-1/2 flex flex-col">
            ...
            <div class="mt-auto bg-brand/5 dark:bg-brand/10 p-6 rounded-2xl border border-brand/20">
                ...
                <a href="https://zalo.me/" target="_blank" class="w-full block text-center bg-brand text-white font-bold py-4 rounded-xl hover:bg-brand-hover hover:shadow-lg hover:shadow-brand/30 transition-all transform hover:-translate-y-1">
