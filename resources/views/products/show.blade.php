...
@section('meta_description', \Illuminate\Support\Str::limit(html_entity_decode(strip_tags(\Illuminate\Support\Str::markdown($product->description)), ENT_QUOTES | ENT_HTML5, 'UTF-8'), 160))
