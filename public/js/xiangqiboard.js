...
(function () {
    ...
    const COLS_LOW = Object.freeze("九八七六五四三二一".split(""));
    ...
    if (RUN_ASSERTS) {
        ...
        console.assert(
            !validFen("rnbakabnr/p1p1p1p1p/9/9/9/9/P1P1P1P1P/RNBAKABN"),
        );
        console.assert(
        ...
        console.assert(
            !validFen(
                "rnbakabnr/p1p1p1p1p/74/9/9/9/P1P1P1P1P/1C5C1/9/RNBAKABNR",
            ),
        );
    ...
    function expandConfig(config) {
        ...
        if (
            !config.hasOwnProperty("boardTheme") ||
            !isString(config.boardTheme)
        ) {
    ...
    function constructor(containerElOrString, config) {
            ...
            for (let i = 0; i < ROW_LENGTH; i++) {
                ...
                for (let j = 0; j < COLUMNS.length; j++) {
                    ...
                    if (config.showNotation) {
                        ...
                        if (row === ROW_TOP) {
                            html +=
                                '<div class="{notation} {alpha}" style="top: 1px; bottom: auto; font-weight: bold;">' +
                                col_top[j] +
                                "</div>";
                        }
                        if (row === ROW_LOW) {
                            html +=
                                '<div class="{notation} {alpha}" style="top: auto; bottom: 1px; font-weight: bold;">' +
                                col_low[j] +
                                "</div>";
                        }
                    }
        ...
        widget.orientation = function (arg) {
            ...
            if (arg === "flip") {
                // flip orientation
                currentOrientation =
                    currentOrientation === "black" ? "red" : "black";
            } else {
                // set to red or black
                if (arg !== "black") {
